module.exports = [
  {
    "id": "chunk-1",
    "text": "#About Me\r\nAs a backend-focused developer with full-stack experience, I thrive on building secure, scalable systems that make a real impact. \r\nAt Excollo, I'm currently working on an Order Management System where I design and implement core backend modules and explore customer clustering using vector databases and ML techniques.\r\nMy core strengths lie in Node.js, Express, and MongoDB, alongside a strong foundation in Java and Spring Boot. \r\nI enjoy architecting clean APIs, solving complex backend problems, and integrating systems that perform efficiently under real-world demands.\r\nOutside of my development work, I’m constantly exploring new technologies, sharpening my problem-solving skills on LeetCode, and working on personal projects that push my learning further. \r\nI believe great software is built at the intersection of thoughtful design, strong architecture, and a passion for continuous improvement."
  },
  {
    "id": "chunk-2",
    "text": "#Experience\r\n    Backend Developer Intern\r\n    Excollo\r\n    Feb 2025 - Present\r\n        CRUDO - \r\n            Contributed to a full-stack order management system (Crudo), integrated with SWIL ERP\r\n            Developed and maintained modules: Order, Customer, Notification, and Store\r\n            Worked with Node.js, Express, MongoDB, JWT, REST APIs, Cron jobs\r\n            Implementing vector database for customer clustering and purchase pattern analysis\r\n\n    Freelance \r\n        Balaji Exports \r\n            Build a business website for Balaji Exports using React and MUI.\r\n\n#Projects"
  },
  {
    "id": "chunk-3",
